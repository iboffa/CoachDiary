...
|---|---------|----------|-------------|-------|-------|
| 1 | Calendar | 4 | 3 | 12 | Unified view of trainings, games, tasks, meetings; will absorb season schedule/events scope |
| 2 | Tasks | 3 | 3 | 9 | Free-form cross-entity tasks with deadlines; reduced priority now that season goals checklist covers much of this need |
